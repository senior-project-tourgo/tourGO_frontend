...
export const placesMock: Place[] = [
...

  {
    ...
    promotions: ['promo_001', 'promo_002'],
    specialFacilities: [
...

  {
    ...
    promotions: ['promo_003'],
    specialFacilities: ['wheelchair-accessibility', 'toilet'],
    image:
...

  {
    ...
    promotions: [],
    specialFacilities: ['kids-friendly', 'parking', 'no-reservations-required'],
    image:
...

  {
    ...
    promotions: ['promo_004', 'promo_005', 'promo_006'],
    specialFacilities: ['parking', 'pet-friendly', 'toilet'],
    image:
...

  {
    ...
    promotions: ['promo_007'],
    specialFacilities: ['parking', 'toilet'],
    image:
...

  {
    ...
    promotions: [],
    specialFacilities: ['kids-friendly', 'parking', 'toilet'],
    image:
...

  {
    ...
    promotions: ['promo_008', 'promo_009'],
    specialFacilities: ['parking', 'no-reservations-required'],
    image:
...

  {
    ...
    promotions: [],
    specialFacilities: ['parking', 'pet-friendly'],
    image:
...

  {
    ...
    promotions: ['promo_011', 'promo_012'],
    specialFacilities: ['toilet', 'no-reservations-required'],
...

  {
    ...
    promotions: ['promo_013'],
    specialFacilities: ['wheelchair-accessibility', 'toilet', 'parking'],
    image:
...

  {
    ...
    promotions: ['promo_015', 'promo_016'],
    specialFacilities: ['kids-friendly', 'toilet', 'no-reservations-required'],
    image:
